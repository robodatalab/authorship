...
export const BODY = `	<div class="topbar" id="topbar">
		<header class="toolbar" id="toolbar">
			...
			<button class="tool" id="fix-style" type="button"
				data-tip="Fix Style &amp; Grammar — read the whole manuscript with Gemini and correct it, a chapter at a time"><i class="codicon codicon-sparkle"></i></button>
		...
		<div class="job" id="job" hidden>
			<div class="job-track"><div class="job-fill" id="job-fill"></div></div>
			<span class="job-said" id="job-said"></span>
			<button class="job-stop" id="job-stop" type="button"
				aria-label="Stop" data-tip="Stop"><i class="codicon codicon-primitive-square"></i></button>
		</div>
	</div>
